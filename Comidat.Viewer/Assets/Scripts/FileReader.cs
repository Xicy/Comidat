    ...
    public sealed class FileReader : IEnumerable<FileReaderLine>, IDisposable
    {
        ...
        public FileReader(string filePath)
        {
            ...
            if (!File.Exists(filePath))
                throw new FileNotFoundException(string.Format("Dosya '{0}' bulunamadı.", filePath));
            ...
            while ((line = _streamReader.ReadLine()) != null)
            {
                    ...
                    (divert = line.StartsWith("divert ")))
                {
                    ...
                    if (includeFilePath != _filePath)
                        ...
                        {
                            throw new FileNotFoundException(string.Format("Gerekli dosya '{0}' bulunamadı.", includeFilePath));
                        }
